...
function Translator() {
	...
	this.logSymbols = [];
	this.logSymbols[tc.NEGATION]      = "¬";//"<img src='imgs/neg.png' alt='\\neg' align='bottom'>";
	this.logSymbols[tc.CONJUNCTION]   = "&";//"<img src='imgs/wedge.png' alt='\\land' align='bottom'>";
	this.logSymbols[tc.DISJUNCTION]   = "v";//"<img src='imgs/vee.png' alt='\\lor' align='bottom'>";
	this.logSymbols[tc.IMPLICATION]   = "➝";//"<img src='imgs/to.png' alt='\\to' align='bottom'>";
	this.logSymbols[tc.BIIMPLICATION] = "↔";//"<img src='imgs/leftrightarrow.png' alt='\\leftrightarrow' align='bottom'>";
	this.logSymbols[tc.UNIVERSAL]     = "∀";//"<img src='imgs/forall.png' alt='\\forall' align='bottom'>";
	this.logSymbols[tc.EXISTENTIAL]   = "∃";//<img src='imgs/exists.png' alt='\\exists' align='bottom'>";
    ...
    this.html2latex = function(str) {
        str = str.replace(new RegExp(translator.logSymbols[tc.UNIVERSAL], "g"), "\\forall");
        str = str.replace(new RegExp(translator.logSymbols[tc.EXISTENTIAL], "g"), "\\exists");
        str = str.replace(new RegExp(translator.logSymbols[tc.NEGATION], "g"), "\\neg");
        str = str.replace(new RegExp(translator.logSymbols[tc.DISJUNCTION], "g"), "\\vee");
        str = str.replace(new RegExp(translator.logSymbols[tc.CONJUNCTION], "g"), "\\wedge");
        str = str.replace(new RegExp(translator.logSymbols[tc.IMPLICATION], "g"), "\\rightarrow");
        str = str.replace(new RegExp(translator.logSymbols[tc.BIIMPLICATION], "g"), "\\leftrightarrow");
        return str;
    }
